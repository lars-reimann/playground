...
public final class HangmanPanel extends JPanel {
    ...
    public HangmanPanel(JButton nextWord, JButton settings, JButton stat,
        ...
        nextWord
                .setIcon(new ImageIcon("pic" + File.separator + "nextWord.png"));
        nextWord.setPressedIcon(new ImageIcon("pic" + File.separator +
                                              "nextWordPressed.png"));
        nextWord
                .setToolTipText("Lasse das aktuelle Wort aus und springe zum folgenden. Das aktuelle Spiel gilt als verloren!");
        add(nextWord);
        ...
        settings
                .setIcon(new ImageIcon("pic" + File.separator + "settings.png"));
        settings.setPressedIcon(new ImageIcon("pic" + File.separator +
                                              "settingsSel.png"));
        settings
                .setToolTipText("Hier kannst du Einstellungen am Spiel vornehmen.");
        add(settings);
        ...
        textField
                .setToolTipText("Gebe hier die Buchstaben ein, die du testen willst.");
        add(textField);
